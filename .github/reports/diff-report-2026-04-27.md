...
Generated: 2026-04-27 08:28:02

## Summary
- kilocode: 585 commits, 1422 files changed
- opencode: 0 commits, 0 files changed

## kilocode Changes (60a1f3c36..ede13b7ec)

### Commits

- ede13b7ec - chore: update nix node_modules hashes (kilo-maintainer[bot], 2026-04-27)
- 39c5a6f5f - Merge pull request #9473 from Kilo-Org/docs/backend-testing-guide (Marian Alexandru Alecu, 2026-04-27)
- 2d3827996 - Merge pull request #9284 from Kilo-Org/docs/plugins (Imanol Maiztegui, 2026-04-27)
- f783a463a - Merge pull request #9526 from Kilo-Org/fix/openrouter-deepseek-reasoning (Imanol Maiztegui, 2026-04-27)
- bd92a0230 - Merge branch 'main' into docs/plugins (Imanol Maiztegui, 2026-04-27)
- 94f47d452 - Merge branch 'main' into fix/openrouter-deepseek-reasoning (Imanol Maiztegui, 2026-04-27)
- cfa8b0ce7 - Merge pull request #9547 from Kilo-Org/fix/shell-cwd-after-login-startup (Imanol Maiztegui, 2026-04-27)
- f63133857 - chore(cli): add kilocode_change markers to ported shell cwd fix (kiloconnect[bot], 2026-04-27)
- e8c13e0ee - fix(cli): preserve shell cwd after login startup (kiloconnect[bot], 2026-04-27)
- 604f44854 - fix(gateway): use updated OpenRouter SDK for DeepSeek reasoning (Josh Lambert, 2026-04-26)
- 55ddf8704 - Revert "fix(cli): also skip interleaved reasoning transform for @kilocode/kilo-gateway" (Josh Lambert, 2026-04-26)
- 7e8e98fa3 - Revert "chore: update changeset to mention Kilo gateway coverage" (Josh Lambert, 2026-04-26)
- fa23641eb - chore: update changeset to mention Kilo gateway coverage (Josh Lambert, 2026-04-26)
- 1dd436d61 - fix(cli): also skip interleaved reasoning transform for @kilocode/kilo-gateway (Josh Lambert, 2026-04-26)
- c8113f27b - chore: add changeset for openrouter/deepseek reasoning fix (Josh Lambert, 2026-04-26)
- a1557d1a1 - chore: annotate cherry-picked upstream changes with kilocode_change markers (Josh Lambert, 2026-04-26)
- c884cea5b - fix: ensure openrouter behaves correctly (Aiden Cline, 2026-04-26)
- be25acb17 - fix: bump openrouter sdk version to resolve deepseek reasoning issue (bug was in sdk pkg) (Aiden Cline, 2026-04-26)
- f724b8f3a - fix: ensure assistant messages always have reasoning on them for deepseek (#24180) (Aiden Cline, 2026-04-26)
- 3d219b5ff - fix: support `max` for deepseek (#24163) (Aiden Cline, 2026-04-26)
- 67de590e7 - fix: deepseek variants (#24157) (Aiden Cline, 2026-04-26)
- ef9b09cd9 - Merge branch 'main' into docs/plugins (Joshua Lambert, 2026-04-25)
- f6be4ee44 - release: v7.2.24 (kilo-maintainer[bot], 2026-04-25)
- 50f35690d - docs(kilo-docs): correct kilo plugin config file paths (Josh Lambert, 2026-04-25)
- fcfaec28e - docs(kilo-docs): inline plugin availability note into intro (Josh Lambert, 2026-04-25)
- 0472e8555 - docs(kilo-docs): drop kilo serve reference from plugins page (Josh Lambert, 2026-04-25)
- 3af9b4a33 - chore: update nix node_modules hashes (kilo-maintainer[bot], 2026-04-24)
- 30867df07 - release: v7.2.23 (kilo-maintainer[bot], 2026-04-24)
- a356f3a92 - fix(cli): respect configured model for subagents (#7549) (Josh Holmer, 2026-04-24)
- e7ded1a59 - Merge pull request #9288 from singhvishalkr/docs/custom-modes-cli-paths (Joshua Lambert, 2026-04-24)
- 2cca21be3 - docs: document legacy custom_modes.yaml path for VSCode extension (Vishal Kumar Singh, 2026-04-24)
- 8ae82e304 - Merge pull request #9290 from singhvishalkr/docs/model-behavior-during-delegation (Joshua Lambert, 2026-04-24)
- c9329a809 - Merge branch 'main' into docs/model-behavior-during-delegation (Joshua Lambert, 2026-04-24)
- c2c31e04a - Update packages/kilo-docs/pages/code-with-ai/agents/model-selection.md (Joshua Lambert, 2026-04-24)
- fb6353276 - docs(model-selection): add current VSCode tab alongside CLI and Legacy (Vishal Kumar Singh, 2026-04-24)
- c58886c99 - docs: add TESTING.md for local backend iteration (Alex Alecu, 2026-04-24)
- 776767343 - Merge pull request #9418 from Kilo-Org/feat/show-pr-in-cli (Marian Alexandru Alecu, 2026-04-24)
- ef209e087 - Merge pull request #9470 from Kilo-Org/fix/cli-preserve-empty-reasoning-content (Christiaan Arnoldus, 2026-04-24)
- 95915efbb - Merge pull request #9439 from Kilo-Org/aboard-monitor (Kirill Kalishev, 2026-04-24)
- a5baf2988 - fix(cli): detect fork parent repo (Alex Alecu, 2026-04-24)
- 7fe4508ee - chore: add changeset (kiloconnect[bot], 2026-04-24)
- 439cba787 - fix(cli): preserve empty reasoning_content in interleaved transform (heimoshuiyu, 2026-04-24)
- 4381d58dd - fix(cli): find fork prs in sidebar (Alex Alecu, 2026-04-24)
- efc2e22d2 - build(deps): bump rustls-webpki in /packages/desktop/src-tauri (#7393) (dependabot[bot], 2026-04-24)
- 33416eee4 - chore(deps): bump @hono/node-server in /packages/opencode (#8927) (dependabot[bot], 2026-04-24)
- bd8fe5769 - Merge branch 'main' into feat/show-pr-in-cli (Marian Alexandru Alecu, 2026-04-24)
- 094bf7426 - fix(docs): add Kilo Code logo to README.md (#6729) (hdcode.dev, 2026-04-24)
- c56f88087 - Merge pull request #9467 from Kilo-Org/imanol/merge-script-fix (Imanol Maiztegui, 2026-04-24)
- 960bcc2cc - Merge branch 'main' into imanol/merge-script-fix (Imanol Maiztegui, 2026-04-24)
- 7b0499887 - chore: update nix node_modules hashes (kilo-maintainer[bot], 2026-04-24)
- a87a461e9 - fix(vscode): align new session and terminal tab behavior in agent manager (#9423) (Marius, 2026-04-24)
- 6bde36edf - Merge branch 'main' into imanol/merge-script-fix (Imanol Maiztegui, 2026-04-24)
- 61516b4d3 - Add @git-changes mention (#9026) (Marius, 2026-04-24)
- 8990d5d12 - refactor(upstream): force-fetch tags when syncing from upstream remote (Imanol Maiztegui, 2026-04-24)
- ed8fb577a - Merge pull request #9458 from Kilo-Org/imanolmaiztegui/kilo-opencode-v1.14.17 (Imanol Maiztegui, 2026-04-24)
- 8eb0bb3e8 - fix(read): skip binary detection for UTF-16 BOM encoded files (Imanol Maiztegui, 2026-04-24)
- 0fab5a6b4 - docs(source-links): add opentelemetry span naming reference URL (Imanol Maiztegui, 2026-04-24)
- 6d14264b1 - fix(opencode): remove unused imports from read tool (Imanol Maiztegui, 2026-04-24)
- 258fe2c8a - Merge branch 'main' into imanolmaiztegui/kilo-opencode-v1.14.17 (Imanol Maiztegui, 2026-04-24)
- ad1cdb550 - release: v7.2.22 (kilo-maintainer[bot], 2026-04-24)
- 17c188338 - Merge pull request #9459 from Kilo-Org/imanol/slot-reactivity (Imanol Maiztegui, 2026-04-24)
- a2ae026f5 - test(tui): trim verbose backstory from slot reactivity test header (Imanol Maiztegui, 2026-04-24)
- 07024a034 - fix(tui): preserve SolidJS prop reactivity in Slot wrapper (Imanol Maiztegui, 2026-04-24)
- fb854a281 - fix(vscode): harden message contract union extraction (#9457) (hdcode.dev, 2026-04-24)
- 35f13cbc8 - fix(vscode): stabilize long session restores (#9444) (Marius, 2026-04-24)
- 93a1a0036 - refactor: adapt kilo compat layer for v1.14.17 API changes (Imanol Maiztegui, 2026-04-24)
- 7d1c046f1 - resolve merge conflicts (Imanol Maiztegui, 2026-04-24)
...
- 0fb7b8a43 - perf(cli): replace gh probe subprocess with Bun.which (Alex Alecu, 2026-04-24)
- 0612739a5 - Merge branch 'main' into feat/show-pr-in-cli (Marian Alexandru Alecu, 2026-04-24)
- 33b90038f - fix(cli): guard autocomplete dismiss (Alex Alecu, 2026-04-24)
- cea4d0e93 - fix(cli): limit sha lookup (Alex Alecu, 2026-04-24)
- 5521ffee2 - refactor(cli): share pr lookup deadline (Alex Alecu, 2026-04-24)
- bf154a3b4 - feat(cli): add sha pr lookup fallback (Alex Alecu, 2026-04-24)
- 6c1e6f363 - feat(cli): add gh availability probe (Alex Alecu, 2026-04-24)
...
- 46176d35e - docs: update plugin issue filing guidance (kirillk, 2026-04-23)
- ae9a75d31 - docs: add JetBrains issue filing guidance (kirillk, 2026-04-23)
...
- ad2386f2a - Merge branch 'main' into feat/show-pr-in-cli (Marian Alexandru Alecu, 2026-04-23)
- 5e50fcb8b - docs: name encoding detection and decoding libraries (kiloconnect[bot], 2026-04-23)
- 4e1d49f6a - fix(cli): bound gh timeout (Alex Alecu, 2026-04-23)
...
- 12c2d86c8 - feat(cli): show open PR for current branch in sidebar (Alex Alecu, 2026-04-23)
...
- 3f507b942 - refactor: kilo compat for v1.14.17 (Imanol Maiztegui, 2026-04-23)
...
- b27ab0a42 - docs: fix legacy mode name Plan -> Architect per review (Vishal Kumar Singh, 2026-04-21)
- 243b70404 - docs: clarify model behavior during agent delegation (Vishal Kumar Singh, 2026-04-21)
- 8d0a0778d - docs: fix legacy lookup table accuracy per review feedback (Vishal Kumar Singh, 2026-04-21)
- 5bf0011eb - docs: document CLI custom modes paths and legacy file lookup order (Vishal Kumar Singh, 2026-04-21)
- 24385747f - docs(kilo-docs): add plugins documentation page (Josh Lambert, 2026-04-20)
...
- a948b1c53 - release: v1.14.17 (opencode, 2026-04-19)
- d18356864 - core: ensure executable permissions are set before Docker builds (Dax Raad, 2026-04-18)
- f27eb8f09 - fix plugins reinstalling too often (Dax Raad, 2026-04-18)
- ad0545335 - ci (Dax Raad, 2026-04-18)
- cfbbae732 - ci (Dax Raad, 2026-04-18)
- 940f971ca - ci: fix (Dax Raad, 2026-04-18)
- 78ca49a1b - test: fix bedrock test (#23351) (Aiden Cline, 2026-04-18)
- 1d54b0e54 - Stefan/enterprise forms waitlist (#23158) (Ryan Vogel, 2026-04-18)
- 7e971d830 - chore: generate (opencode-agent[bot], 2026-04-18)
- 54b3b3fe0 - zen: redeem go (Frank, 2026-04-18)
- 9d012b062 - zen: redeem credit (Frank, 2026-04-18)
- fbb0a93e1 - chore: update nix node_modules hashes (opencode-agent[bot], 2026-04-18)
- e2e7a8d72 - fix: ensure display: summarized is sent by default for bedrock (#23343) (Aiden Cline, 2026-04-18)
- ce7923ada - chore: bump @ai-sdk/amazon-bedrock (#23341) (Aiden Cline, 2026-04-18)
- a26d53151 - tui: allow full-session forks from the session dialog (#23339) (Dax, 2026-04-18)
- 5eaef6b75 - release: avoid package.json drift during publish (Dax Raad, 2026-04-18)
- c5c38cad9 - chore: generate (opencode-agent[bot], 2026-04-18)
- 9918f389e - fix: detect attachment mime from file contents (#23291) (Kit Langton, 2026-04-18)
- dd8c42480 - chore: generate (opencode-agent[bot], 2026-04-18)
- 078d8a07c - core: support OTEL_RESOURCE_ATTRIBUTES environment variable for custom telemetry attributes (Dax Raad, 2026-04-18)
- 1ee712e54 - core: fix early return when node_modules is missing during package install (Dax Raad, 2026-04-18)
- 55315bdff - tui: fix sync loading indicator to properly show loading state on startup (Dax Raad, 2026-04-18)
- 882b8e1e7 - core: track retry attempts with detailed error context on assistant entries (Dax Raad, 2026-04-18)
- 95edbc0ae - chore: generate (opencode-agent[bot], 2026-04-18)
- 11cd4fb63 - core: extract session entry stepping logic into dedicated module (Dax Raad, 2026-04-18)
- 9c16bd1e3 - fix: make skills logic more token efficient (#23253) (Aiden Cline, 2026-04-17)
- 5e9d5c734 - chore: generate (opencode-agent[bot], 2026-04-18)
- b382d1a46 - docs(effect): track schema migration progress with concrete file checklists (#23242) (Kit Langton, 2026-04-18)
- 23f31475e - refactor(config): migrate config.ts root Info to Effect Schema (#23241) (Kit Langton, 2026-04-18)
- c0eab9e44 - fix(desktop): adjust ui tool diff sticky header offset (#23149) (OpeOginni, 2026-04-18)
- 8a1e85d0c - chore: generate (opencode-agent[bot], 2026-04-18)
- 2793502db - refactor(config): migrate agent.ts Info to Effect Schema (#23237) (Kit Langton, 2026-04-18)
- 9f7bd0246 - chore: generate (opencode-agent[bot], 2026-04-18)
- a6a4350d1 - refactor(config): migrate permission.ts Info to Effect Schema (#23231) (Kit Langton, 2026-04-18)
- 471b9f4dc - refactor: use InstanceState context in worktree cleanup paths (#23019) (Kit Langton, 2026-04-17)
- 24fb9b129 - fix: stop rewriting dev during release publish (#22982) (Kit Langton, 2026-04-18)
- 357301991 - fix(generate): make openapi output deterministic by formatting in-place (#23228) (Kit Langton, 2026-04-17)
- fc5b35314 - refactor(config): migrate keybinds.ts to Effect Schema (#23227) (Kit Langton, 2026-04-18)
- 1dd257b76 - refactor: use instance state in small services (#23022) (Kit Langton, 2026-04-18)
- 5fa167334 - refactor: use InstanceState context in File service (#23015) (Kit Langton, 2026-04-17)
- daaa1c7e2 - chore: generate (opencode-agent[bot], 2026-04-18)
- 1fae784b8 - feat(effect-zod): add ZodPreprocess annotation for pre-parse transforms (#23222) (Kit Langton, 2026-04-18)
- 81b7b58a5 - fix: gh copilot issue w/ haiku (eager_input_streaming not supported) (#23223) (Aiden Cline, 2026-04-17)
- 866188a64 - chore: generate (opencode-agent[bot], 2026-04-18)
- e6fd57165 - refactor: remove ambient instance reads from lsp (#23023) (Kit Langton, 2026-04-17)
- a5d99e7a3 - refactor: pass formatter instance context explicitly (#23020) (Kit Langton, 2026-04-18)
- a92c75e5f - chore: generate (opencode-agent[bot], 2026-04-18)
- 826fd3350 - refactor(config): migrate Server + Layout to Effect Schema (#23216) (Kit Langton, 2026-04-18)
- 23a2d0128 - fix(observability): standardize session telemetry attrs (#23213) (Kit Langton, 2026-04-17)
- 5181f9b4e - refactor(config): drop ZodOverride from PositiveInt in provider.ts (#23215) (Kit Langton, 2026-04-18)
- f52ae2843 - chore: generate (opencode-agent[bot], 2026-04-18)
- 36119ff17 - feat(effect-zod): translate Schema.withDecodingDefault into zod .default() (#23207) (Kit Langton, 2026-04-17)
- bb90f3bbf - feat(effect-zod): translate well-known filters into native Zod methods (#23209) (Kit Langton, 2026-04-17)
- 05cdb7c10 - refactor(v2): tag session unions and exhaustively match events (#23201) (Kit Langton, 2026-04-18)
- b493dabfe - docs(effect): refresh migration status specs (#23206) (Kit Langton, 2026-04-18)
- c4816f944 - chore: generate (opencode-agent[bot], 2026-04-18)
- 211136e3a - feat(effect-zod): transform support + walk memoization + flattened checks (#23203) (Kit Langton, 2026-04-18)
- cf0a53c50 - chore: generate (opencode-agent[bot], 2026-04-18)
- 289998481 - refactor(config): migrate provider (Model + Info) to Effect Schema (#23197) (Kit Langton, 2026-04-18)
- eafbe5c57 - refactor(server): align route-span attrs with OTel semantic conventions (#23198) (Kit Langton, 2026-04-18)
- 7b98f544f - feat(effect-zod): add catchall (StructWithRest) support to the walker (#23186) (Kit Langton, 2026-04-18)
- b5aba5807 - feat(tui): show session ID in sidebar on non-prod channels (#23185) (Kit Langton, 2026-04-18)
- d5c4c26b4 - feat(server): auto-tag route spans with route params (session.id, message.id, …) (#23189) (Kit Langton, 2026-04-18)
- a35b8a95c - release: v1.4.11 (opencode, 2026-04-18)
- cded68a2e - refactor(npm): use object-based package spec for install API (#23181) (Dax, 2026-04-17)
- 0068ccec3 - fix: ensure copilot model list filters out disabled models (#23176) (Aiden Cline, 2026-04-17)
- 89e8994fd - chore: generate (opencode-agent[bot], 2026-04-17)
- 5980b0a5e - feat(effect-zod): add tuple support; migrate config/plugin to Effect Schema (#23178) (Kit Langton, 2026-04-17)
- 89029a20e - chore: generate (opencode-agent[bot], 2026-04-17)
- ce69bd97b - refactor(config): migrate model-id and command to Effect Schema (#23175) (Kit Langton, 2026-04-17)
- 999d8651a - feat(server): wrap remaining route handlers in request spans (#23169) (Kit Langton, 2026-04-17)
- ed0f02250 - chore: generate (opencode-agent[bot], 2026-04-17)
- b1307d5c2 - refactor(config): migrate skills, formatter, console-state to Effect Schema (#23162) (Kit Langton, 2026-04-17)
- dc16013b4 - chore: generate (opencode-agent[bot], 2026-04-17)
- e7686dbd6 - feat(effect-zod): translate Schema.check filters into zod .superRefine + promote LSP refinement to Effect layer (#23173) (Kit Langton, 2026-04-17)
- 47f553f9b - fix(core): more explicit routing to fix workspace instance issue (#23171) (James Long, 2026-04-17)
- d11268ece - refactor(config): migrate permission Action/Object/Rule leaves to Effect Schema (#23168) (Kit Langton, 2026-04-17)
- 650a13a69 - refactor(config): migrate lsp schemas to Effect Schema (#23167) (Kit Langton, 2026-04-17)
- 54435325b - chore: generate (opencode-agent[bot], 2026-04-17)
- 11fa25754 - refactor(config): migrate mcp schemas to Effect Schema.Class (#23163) (Kit Langton, 2026-04-17)
...
- `packages/opencode/src/kilocode/tool/read-directory.ts` (+0, -47)
- `packages/opencode/src/kilocode/tool/registry.ts` (+2, -8)
- `packages/opencode/src/kilocode/tool/task.ts` (+36, -1)
...
- `packages/opencode/src/tool/mcp-exa.ts` (+3, -1)
...
- `packages/opencode/src/tool/read.ts` (+126, -83)
...
- `packages/opencode/src/tool/skill.ts` (+71, -94)
- `packages/opencode/src/tool/skill.txt` (+5, -0)
- `packages/opencode/src/tool/task.ts` (+14, -6)
...
- `packages/opencode/src/tool/webfetch.ts` (+4, -6)
...
- `.changeset/openrouter-deepseek-reasoning.md` (+6, -0)
...
- `.kilo/package-lock.json` (+376, -0)
- `.kilocode/package-lock.json` (+376, -0)
- `.oxlintrc.json` (+51, -0)
- `AGENTS.md` (+10, -0)
- `README.md` (+3, -2)
- `TESTING.md` (+261, -0)
...
- `packages/app/src/components/titlebar.tsx` (+44, -34)
...
- `packages/desktop/src-tauri/Cargo.lock` (+49, -49)
...
- `packages/kilo-docs/pages/customize/custom-modes.md` (+31, -0)
...
- `packages/kilo-vscode/CHANGELOG.md` (+80, -0)
...
- `packages/kilo-vscode/src/KiloProvider.ts` (+25, -49)
- `packages/kilo-vscode/src/agent-manager/AgentManagerProvider.ts` (+45, -9)
...
- `packages/kilo-vscode/src/kilo-provider/git-changes-context.ts` (+28, -0)
- `packages/kilo-vscode/src/kilo-provider/git-changes-request.ts` (+32, -0)
- `packages/kilo-vscode/src/kilo-provider/git-changes-target.ts` (+24, -0)
- `packages/kilo-vscode/src/kilo-provider/message-page.ts` (+6, -2)
...
- `packages/kilo-vscode/src/services/git/context.ts` (+213, -0)
...
- `packages/kilo-vscode/tests/unit/file-mention-utils.test.ts` (+18, -2)
- `packages/kilo-vscode/tests/unit/git-context.test.ts` (+130, -0)
...
- `packages/kilo-vscode/tests/unit/message-contract.test.ts` (+50, -29)
- `packages/kilo-vscode/tests/unit/message-page.test.ts` (+30, -0)
...
- `packages/kilo-vscode/tests/unit/session-queue.test.ts` (+56, -1)
- `packages/kilo-vscode/tests/unit/settings-io.test.ts` (+2, -2)
- `packages/kilo-vscode/tests/unit/tab-order-sync.test.ts` (+223, -0)
- `packages/kilo-vscode/tests/unit/tab-order.test.ts` (+64, -1)
...
- `packages/kilo-vscode/webview-ui/agent-manager/AgentManagerApp.tsx` (+320, -245)
...
- `packages/kilo-vscode/webview-ui/agent-manager/tab-order-sync.ts` (+83, -0)
- `packages/kilo-vscode/webview-ui/agent-manager/tab-order.ts` (+27, -0)
...
- `packages/kilo-vscode/webview-ui/src/components/chat/MessageList.tsx` (+6, -2)
- `packages/kilo-vscode/webview-ui/src/components/chat/PromptInput.tsx` (+36, -9)
- `packages/kilo-vscode/webview-ui/src/components/chat/QuestionDock.tsx` (+4, -11)
- `packages/kilo-vscode/webview-ui/src/components/chat/VscodeSessionTurn.tsx` (+30, -26)
...
- `packages/kilo-vscode/webview-ui/src/context/session-queue.ts` (+73, -4)
- `packages/kilo-vscode/webview-ui/src/context/session.tsx` (+0, -48)
- `packages/kilo-vscode/webview-ui/src/hooks/file-mention-utils.ts` (+17, -2)
- `packages/kilo-vscode/webview-ui/src/hooks/git-changes-context-utils.ts` (+42, -0)
- `packages/kilo-vscode/webview-ui/src/hooks/useFileMention.ts` (+7, -3)
- `packages/kilo-vscode/webview-ui/src/hooks/useGitChangesContext.ts` (+86, -0)
...
- `packages/kilo-vscode/webview-ui/src/stories/chat.stories.tsx` (+145, -10)
...
- `packages/kilo-vscode/webview-ui/src/types/messages/extension-messages.ts` (+921, -0)
...
- `packages/kilo-vscode/webview-ui/src/types/messages/webview-messages.ts` (+1056, -0)
- `packages/opencode/.gitignore` (+3, -0)
- `packages/opencode/CHANGELOG.md` (+72, -0)
- `packages/opencode/package.json` (+13, -9)
- `packages/opencode/script/build.ts` (+1, -3)
- `packages/opencode/script/postinstall.mjs` (+1, -1)
- `packages/opencode/script/publish.ts` (+24, -9)
...
- `packages/opencode/specs/effect/facades.md` (+32, -49)
- `packages/opencode/specs/effect/http-api.md` (+152, -85)
- `packages/opencode/specs/effect/instance-context.md` (+310, -0)
- `packages/opencode/specs/effect/loose-ends.md` (+6, -8)
- `packages/opencode/specs/effect/migration.md` (+35, -43)
- `packages/opencode/specs/effect/routes.md` (+16, -18)
- `packages/opencode/specs/effect/schema.md` (+254, -28)
- `packages/opencode/specs/effect/server-package.md` (+19, -17)
- `packages/opencode/specs/effect/tools.md` (+3, -5)
...
- `packages/opencode/src/cli/cmd/generate.ts` (+13, -1)
...
- `packages/opencode/src/cli/cmd/tui/app.tsx` (+27, -19)
- `packages/opencode/src/cli/cmd/tui/attach.ts` (+2, -7)
- `packages/opencode/src/cli/cmd/tui/component/bg-pulse.tsx` (+130, -0)
- `packages/opencode/src/cli/cmd/tui/component/dialog-command.tsx` (+1, -0)
...
- `packages/opencode/src/cli/cmd/tui/component/dialog-session-list.tsx` (+100, -17)
...
- `packages/opencode/src/cli/cmd/tui/component/dialog-workspace-create.tsx` (+140, -4)
- `packages/opencode/src/cli/cmd/tui/component/dialog-workspace-unavailable.tsx` (+81, -0)
...
- `packages/opencode/src/cli/cmd/tui/component/prompt/index.tsx` (+164, -62)
...
- `packages/opencode/src/cli/cmd/tui/plugin/slots.tsx` (+15, -1)
- `packages/opencode/src/cli/cmd/tui/routes/home.tsx` (+2, -3)
- `packages/opencode/src/cli/cmd/tui/routes/session/dialog-fork-from-timeline.tsx` (+21, -10)
...
- `packages/opencode/src/cli/cmd/tui/routes/session/index.tsx` (+89, -118)
...
- `packages/opencode/src/cli/cmd/tui/routes/session/sidebar.tsx` (+25, -2)
- `packages/opencode/src/cli/cmd/tui/routes/session/subagent-footer.tsx` (+2, -2)
- `packages/opencode/src/cli/cmd/tui/thread.ts` (+15, -15)
...
- `packages/opencode/src/cli/cmd/tui/util/signal.ts` (+35, -1)
...
- `packages/opencode/src/cli/cmd/tui/worker.ts` (+6, -3)
...
- `packages/opencode/src/config/agent.ts` (+224, -0)
- `packages/opencode/src/config/command.ts` (+87, -0)
- `packages/opencode/src/config/config.ts` (+671, -1616)
- `packages/opencode/src/config/console-state.ts` (+11, -10)
- `packages/opencode/src/config/entry-name.ts` (+16, -0)
- `packages/opencode/src/config/error.ts` (+21, -0)
- `packages/opencode/src/config/formatter.ts` (+17, -0)
- `packages/opencode/src/config/index.ts` (+16, -0)
- `packages/opencode/src/config/keybinds.ts` (+128, -0)
- `packages/opencode/src/config/layout.ts` (+10, -0)
- `packages/opencode/src/config/lsp.ts` (+45, -0)
- `packages/opencode/src/config/managed.ts` (+70, -0)
- `packages/opencode/src/config/markdown.ts` (+80, -82)
- `packages/opencode/src/config/mcp.ts` (+62, -0)
- `packages/opencode/src/config/model-id.ts` (+14, -0)
- `packages/opencode/src/config/parse.ts` (+44, -0)
- `packages/opencode/src/config/paths.ts` (+48, -160)
- `packages/opencode/src/config/permission.ts` (+76, -0)
- `packages/opencode/src/config/plugin.ts` (+88, -0)
- `packages/opencode/src/config/provider.ts` (+116, -0)
- `packages/opencode/src/config/server.ts` (+20, -0)
- `packages/opencode/src/config/skills.ts` (+16, -0)
...
- `packages/opencode/src/control-plane/workspace.ts` (+543, -158)
- `packages/opencode/src/effect/app-runtime.ts` (+18, -18)
- `packages/opencode/src/effect/bootstrap-runtime.ts` (+6, -4)
...
- `packages/opencode/src/effect/logger.ts` (+62, -56)
- `packages/opencode/src/effect/memo-map.ts` (+3, -0)
- `packages/opencode/src/effect/observability.ts` (+80, -41)
- `packages/opencode/src/effect/run-service.ts` (+23, -7)
- `packages/opencode/src/effect/runner.ts` (+184, -186)
- `packages/opencode/src/effect/runtime.ts` (+19, -0)
- `packages/opencode/src/env/index.ts` (+35, -54)
- `packages/opencode/src/file/ignore.ts` (+69, -70)
- `packages/opencode/src/file/index.ts` (+604, -610)
- `packages/opencode/src/file/protected.ts` (+19, -19)
- `packages/opencode/src/file/ripgrep.ts` (+493, -499)
- `packages/opencode/src/file/ripgrep.worker.ts` (+5, -6)
- `packages/opencode/src/file/time.ts` (+0, -114)
- `packages/opencode/src/file/watcher.ts` (+124, -124)
- `packages/opencode/src/flag/flag.ts` (+81, -144)
- `packages/opencode/src/format/formatter.ts` (+24, -22)
...
- `packages/opencode/src/index.ts` (+17, -10)
...
- `packages/opencode/src/kilocode/config-validation.ts` (+32, -7)
- `packages/opencode/src/kilocode/config/config.ts` (+18, -19)
...
- `packages/opencode/src/kilocode/plugins/sidebar-pr.tsx` (+286, -0)
...
- `packages/opencode/src/lsp/client.ts` (+202, -205)
...
- `packages/opencode/src/lsp/lsp.ts` (+535, -0)
- `packages/opencode/src/lsp/server.ts` (+1691, -1693)
- `packages/opencode/src/mcp/auth.ts` (+134, -134)
- `packages/opencode/src/mcp/index.ts` (+820, -817)
...
- `packages/opencode/src/npm/index.ts` (+270, -165)
...
- `packages/opencode/src/plugin/github-copilot/copilot.ts` (+23, -8)
- `packages/opencode/src/plugin/github-copilot/models.ts` (+134, -127)
- `packages/opencode/src/plugin/index.ts` (+242, -245)
- `packages/opencode/src/plugin/install.ts` (+3, -3)
- `packages/opencode/src/plugin/loader.ts` (+55, -13)
...
- `packages/opencode/src/project/instance.ts` (+9, -9)
- `packages/opencode/src/project/project.ts` (+429, -428)
- `packages/opencode/src/project/vcs.ts` (+213, -219)
...
- `packages/opencode/src/provider/provider.ts` (+1552, -1542)
...
- `packages/opencode/src/provider/transform.ts` (+995, -906)
...
- `packages/opencode/src/server/proxy.ts` (+69, -31)
- `packages/opencode/src/server/{ => routes}/control/index.ts` (+2, -4)
...
- `packages/opencode/src/server/routes/instance/config.ts` (+136, -0)
...
- `packages/opencode/src/server/{ => routes}/instance/experimental.ts` (+101, -118)
- `packages/opencode/src/server/{ => routes}/instance/file.ts` (+39, -59)
...
- `packages/opencode/src/server/{ => routes}/instance/index.ts` (+74, -60)
- `packages/opencode/src/server/{ => routes}/instance/kilocode.ts` (+6, -6)
- `packages/opencode/src/server/{ => routes}/instance/mcp.ts` (+52, -37)
- `packages/opencode/src/server/routes/instance/middleware.ts` (+35, -0)
- `packages/opencode/src/server/{ => routes}/instance/network.ts` (+3, -3)
- `packages/opencode/src/server/{ => routes}/instance/permission.ts` (+34, -37)
- `packages/opencode/src/server/{ => routes}/instance/project.ts` (+21, -17)
- `packages/opencode/src/server/routes/instance/provider.ts` (+161, -0)
- `packages/opencode/src/server/{ => routes}/instance/pty.ts` (+32, -43)
- `packages/opencode/src/server/{ => routes}/instance/question.ts` (+27, -26)
- `packages/opencode/src/server/{ => routes}/instance/remote.ts` (+1, -1)
- `packages/opencode/src/server/{ => routes}/instance/session.ts` (+230, -233)
- `packages/opencode/src/server/routes/instance/suggestion.ts` (+2, -0)
- `packages/opencode/src/server/routes/instance/sync.ts` (+143, -0)
- `packages/opencode/src/server/{ => routes}/instance/telemetry.ts` (+2, -2)
- `packages/opencode/src/server/routes/instance/trace.ts` (+59, -0)
- `packages/opencode/src/server/{ => routes}/instance/tui.ts` (+12, -8)
- `packages/opencode/src/server/{ui/index.ts => routes/ui.ts}` (+0, -0)
- `packages/opencode/src/server/server.ts` (+110, -83)
- `packages/opencode/src/server/{instance/middleware.ts => workspace.ts}` (+34, -47)
- `packages/opencode/src/session/compaction.ts` (+342, -339)
- `packages/opencode/src/session/index.ts` (+1, -872)
- `packages/opencode/src/session/instruction.ts` (+172, -171)
- `packages/opencode/src/session/llm.ts` (+447, -427)
- `packages/opencode/src/session/message-v2.ts` (+966, -975)
...
- `packages/opencode/src/session/prompt.ts` (+1688, -1641)
...
- `packages/opencode/src/session/session.ts` (+877, -0)
...
- `packages/opencode/src/share/share-next.ts` (+328, -305)
...
- `packages/opencode/src/util/effect-zod.ts` (+284, -15)
...
- `packages/opencode/src/util/media.ts` (+26, -0)
- `packages/opencode/src/util/opencode-process.ts` (+24, -0)
...
- `packages/opencode/src/v2/session-entry-stepper.ts` (+261, -0)
- `packages/opencode/src/v2/session-entry.ts` (+199, -297)
- `packages/opencode/src/v2/session-event.ts` (+19, -4)
- `packages/opencode/src/v2/session.ts` (+50, -52)
- `packages/opencode/src/worktree/index.ts` (+501, -502)
...
- `packages/opencode/test/cli/tui/plugin-loader-entrypoint.test.ts` (+31, -39)
...
- `packages/opencode/test/config/lsp.test.ts` (+87, -0)
...
- `packages/opencode/test/effect/observability.test.ts` (+46, -0)
...
- `packages/opencode/test/kilocode/config-gitignore.test.ts` (+59, -29)
...
- `packages/opencode/test/kilocode/config/opentelemetry-default.test.ts` (+30, -0)
...
- `packages/opencode/test/kilocode/lsp-typescript-lightweight.test.ts` (+9, -10)
...
- `packages/opencode/test/kilocode/slot-prop-reactivity.test.ts` (+142, -0)
...
- `packages/opencode/test/kilocode/tool-task-model.test.ts` (+352, -0)
- `packages/opencode/test/kilocode/transform-opus-4.7.test.ts` (+3, -3)
- `packages/opencode/test/lib/llm-server.ts` (+0, -24)
- `packages/opencode/test/lsp/client.test.ts` (+6, -3)
- `packages/opencode/test/lsp/index.test.ts` (+88, -35)
...
- `packages/opencode/test/plugin/loader-shared.test.ts` (+16, -16)
...
- `packages/opencode/test/provider/provider.test.ts` (+99, -63)
- `packages/opencode/test/provider/transform.test.ts` (+219, -3)
...
- `packages/opencode/test/server/trace-attributes.test.ts` (+76, -0)
- `packages/opencode/test/session/compaction.test.ts` (+6, -25)
- `packages/opencode/test/session/llm.test.ts` (+269, -7)
- `packages/opencode/test/session/message-v2.test.ts` (+160, -1)
...
- `packages/opencode/test/session/prompt-effect.test.ts` (+45, -33)
...
- `packages/opencode/test/session/session-entry-stepper.test.ts` (+916, -0)
- `packages/opencode/test/session/session-entry.test.ts` (+0, -624)
...
- `packages/opencode/test/util/effect-zod.test.ts` (+812, -4)
...
- `packages/opencode/test/workspace/workspace-restore.test.ts` (+281, -0)
- `packages/opencode/tsconfig.json` (+2, -1)
- `packages/plugin/package.json` (+5, -5)
- `packages/plugin/script/publish.ts` (+27, -11)
- `packages/plugin/src/example.ts` (+1, -1)
- `packages/plugin/src/tool.ts` (+3, -1)
- `packages/plugin/src/tui.ts` (+1, -2)
- `packages/script/package.json` (+1, -1)
- `packages/sdk/js/package.json` (+1, -1)
- `packages/sdk/js/script/publish.ts` (+32, -18)
- `packages/sdk/js/src/v2/data.ts` (+1, -1)
- `packages/sdk/js/src/v2/gen/sdk.gen.ts` (+464, -276)
- `packages/sdk/js/src/v2/gen/types.gen.ts` (+416, -270)
...
- `packages/shared/src/util/effect-flock.ts` (+283, -0)
...
- `packages/ui/src/components/message-part.tsx` (+5, -6)
...
- `script/upstream/utils/git.ts` (+1, -1)
...
## opencode Changes (224548d..2789b77)
...
- `src/tool/skill.txt.ts` - update based on kilocode packages/opencode/src/tool/skill.txt changes
