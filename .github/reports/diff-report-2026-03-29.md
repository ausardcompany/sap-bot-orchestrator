...
Generated: 2026-03-29 07:06:00

## Summary
- kilocode: 69 commits, 110 files changed
- opencode: 62 commits, 250 files changed
...
## opencode Changes (7715252..a5b1dc0)
...
- `packages/opencode/package.json` (+27, -26)
...
- `packages/opencode/src/session/llm.ts` (+33, -12)
