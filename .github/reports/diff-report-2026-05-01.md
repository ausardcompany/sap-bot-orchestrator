...
Generated: 2026-05-01 08:12:56

## Summary
- kilocode: 310 commits, 662 files changed
- opencode: 0 commits, 0 files changed

## kilocode Changes (2a6c3e7d5..010fc16cf)
...
#### Other Changes
- `.changeset/agent-manager-tool.md` (+6, -0)
- `.changeset/auto-approve-header-light-theme.md` (+0, -5)
- `.changeset/autocomplete-listener-dispose.md` (+5, -0)
- `.changeset/autocomplete-model-switch-back.md` (+0, -5)
- `.changeset/center-sidebar-toolbar.md` (+5, -0)
- `.changeset/center-wide-notifications.md` (+5, -0)
- `.changeset/chat-toolbar-changes.md` (+0, -5)
- `.changeset/chilly-dancers-build.md` (+5, -0)
- `.changeset/command-permissions-persist.md` (+5, -0)
- `.changeset/commit-prompt-project-scope.md` (+6, -0)
- `.changeset/edit-tool-diff-split-view.md` (+0, -5)
- `.changeset/expanded-reasoning-blocks.md` (+5, -0)
...
- `.changeset/gpt55-codex-prompt.md` (+5, -0)
- `.changeset/green-planes-reply.md` (+5, -0)
- `.changeset/local-sessions-restart.md` (+5, -0)
- `.changeset/per-agent-permissions.md` (+5, -0)
- `.changeset/remote-status-badge.md` (+5, -0)
- `.changeset/remove-ai-gen_ai-telemetry.md` (+6, -0)
- `.changeset/sidebar-worktree-actions.md` (+0, -5)
- `.changeset/slow-terms-dance.md` (+5, -0)
- `.changeset/soft-garlic-care.md` (+5, -0)
- `.changeset/terminal-command-display.md` (+5, -0)
...
- `packages/shared/src/global.ts` (+8, -5)
...
## opencode Changes (9d1f17d..21f8027)
