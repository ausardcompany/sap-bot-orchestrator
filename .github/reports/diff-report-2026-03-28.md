...
Generated: 2026-03-28 20:16:01

## Summary
- kilocode: 69 commits, 110 files changed
- opencode: 47 commits, 209 files changed

## kilocode Changes (121f6e3c..43811bfa)
...
- `packages/kilo-vscode/webview-ui/src/i18n/ar.ts` (+29, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/br.ts` (+33, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/bs.ts` (+32, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/da.ts` (+31, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/de.ts` (+34, -7)
- `packages/kilo-vscode/webview-ui/src/i18n/en.ts` (+29, -8)
- `packages/kilo-vscode/webview-ui/src/i18n/es.ts` (+34, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/fr.ts` (+33, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/ja.ts` (+32, -7)
- `packages/kilo-vscode/webview-ui/src/i18n/ko.ts` (+31, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/nl.ts` (+31, -8)
- `packages/kilo-vscode/webview-ui/src/i18n/no.ts` (+31, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/pl.ts` (+32, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/ru.ts` (+31, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/th.ts` (+30, -6)
- `packages/kilo-vscode/webview-ui/src/i18n/tr.ts` (+30, -8)
- `packages/kilo-vscode/webview-ui/src/i18n/zh.ts` (+27, -7)
- `packages/kilo-vscode/webview-ui/src/i18n/zht.ts` (+27, -6)
...
## opencode Changes (7715252..1f290fc)
...
- `packages/opencode/src/tool/bash.ts` (+4, -3)
...
- `.opencode/plugins/tui-smoke.tsx` (+861, -0)
...
- `packages/console/function/package.json` (+3, -3)
...
- `packages/opencode/package.json` (+26, -25)
...
- `packages/opencode/specs/tui-plugins.md` (+385, -0)
...
- `packages/opencode/src/cli/cmd/tui/app.tsx` (+186, -185)
- `packages/opencode/src/cli/cmd/tui/component/dialog-command.tsx` (+30, -6)
- `packages/opencode/src/cli/cmd/tui/component/dialog-model.tsx` (+12, -4)
- `packages/opencode/src/cli/cmd/tui/component/dialog-status.tsx` (+2, -1)
- `packages/opencode/src/cli/cmd/tui/component/dialog-variant.tsx` (+30, -0)
...
- `packages/opencode/src/cli/cmd/tui/component/prompt/index.tsx` (+41, -12)
...
- `packages/opencode/src/cli/cmd/tui/plugin/api.tsx` (+406, -0)
...
- `packages/opencode/src/cli/cmd/tui/routes/home.tsx` (+9, -39)
...
- `packages/opencode/src/plugin/install.ts` (+351, -0)
...
- `packages/opencode/src/session/compaction.ts` (+331, -243)
- `packages/opencode/src/session/index.ts` (+490, -383)
- `packages/opencode/src/session/llm.ts` (+34, -12)
...
- `packages/opencode/src/session/prompt.ts` (+39, -30)
...
- `packages/opencode/test/fixture/tui-plugin.ts` (+334, -0)
...
- `packages/opencode/test/plugin/install.test.ts` (+410, -0)
...
- `packages/opencode/test/session/compaction.test.ts` (+668, -1)
...
- `packages/plugin/package.json` (+16, -1)
- `packages/plugin/src/index.ts` (+19, -4)
- `packages/plugin/src/tui.ts` (+423, -0)
...
```diff
diff --git a/packages/opencode/src/provider/sdk/copilot/responses/tool/local-shell.ts b/packages/opencode/src/provider/sdk/copilot/responses/tool/local-shell.ts
index 4ceca0d..45230d5 100644
--- a/packages/opencode/src/provider/sdk/copilot/responses/tool/local-shell.ts
+++ b/packages/opencode/src/provider/sdk/copilot/responses/tool/local-shell.ts
@@ -1,4 +1,4 @@
-import { createProviderDefinedToolFactoryWithOutputSchema } from "@ai-sdk/provider-utils"
+import { createProviderToolFactoryWithOutputSchema } from "@ai-sdk/provider-utils"
 import { z } from "zod/v4"
