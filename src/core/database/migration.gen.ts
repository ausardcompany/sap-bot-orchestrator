...
export const MIGRATION_MODULES: ReadonlyArray<Promise<{ default: Migration }>> = [
  ...
  // 2026-09-03: board reset semantics — `cleared_seq` bookkeeping so a
  // swarm can logically clear the board without deleting history
  // (kilocode board_reset migration).
